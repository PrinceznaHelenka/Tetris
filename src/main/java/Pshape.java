...
public class Pshape extends main.java.Shape implements Tetromino{

    private int stav = 1;


    public Pshape(Color color, GameBoard gameBoard){
        this.color = color;
        ...
        fieldcoord[2] = new Field(4, 1);
        fieldcoord[3] = new Field(4, 0);
